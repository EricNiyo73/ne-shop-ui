      ...
      <div className="about-section  flex flex-wrap  justify-between">
        <div className="tablet:w-[50%] p-2 flex flex-col gap-5 items-start justify-start">
          ...
          <p className="description">
            NE-Shop is an e-commerce website that eases the commerce structure.
            Lorem ipsum dolor sit amet consectetur. In eu aliquet orci ac risus
            lobortis aenean diam aenean. Quam sodales faucibus amet.
          </p>
          <p className="description">
            NE-Shop is an e-commerce website that eases the commerce structure.
      ...
      <div className="team-section">
        ...
        <div className="section-content flex flex-row gap-5 flex-wrap">
          <TeamCard
            ...
            linkedin={
              "https://www.linkedin.com/in/gatete-ishema-angelo-christian-332196178/"
            }
