    ...
    <footer className="bg-black w-full ">
      <div className="footer bg-black w-full p-5 px-10 flex flex-row flex-wrap justify-between flex-1 items-start py-12">
        <div className="items-start justify-center flex flex-col w-[90%] mb-10 tablet:mb-0 tablet:w-[30%] space-y-4">
          ...
          <p className="text-xs text-gray-400 text-start w-[70%]">
            We have your satisfaction in mind Lorem ipsum dolor sit amet
            consectetur. In eu aliquet orci ac{" "}
          </p>
        ...
        <div className="items-start justify-center flex flex-col w-[40%] bigphone:w-[12%] space-y-2 mb-10 phone:mb-0">
          <p className="text-gray-200 font-semibold text-sm text-white">
            Account
          </p>
          <p className=" text-xs  text-start hover:white transition-all">
        ...
        <div className="items-start justify-center flex flex-col w-[80%] bigphone:w-[25%]  mt-4 bigphone:mt-1 space-y-2 mb-10 phone:mb-0">
          ...
          <div className="flex-between items-start space-x-2">
            ...
            <div>
              <p className="text-xs text-gray-200 text-start text-white">
                Whatsapp
              </p>
              <p className="text-xs text-gray-400 text-start hover:text-gray-200 transition-all ">
                <Link to={""}>+250 788 888 888</Link>
              </p>
            </div>
          </div>
          <div className="flex-between items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 text-start hover:text-gray-200 transition-all ">
                <Link to={"tel:+250 788 888 888"}>+250 78600 7088</Link>
              </p>
            </div>
          </div>
          <div className="flex-between items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-[10px] tablet:text-xs text-gray-400 text-start hover:text-gray-200 transition-all ">
                <Link to={"bitcrafter.andela@gmail.com"}>
      ...
      <div className="p-6 flex items-center w-[80%] m-auto justify-center border-t-[1px] border-gray_100">
        <p className="text-xs text-gray-400">
          &copy; {year} All rights reserved - ne-shop
        </p>
      </div>
    </footer>
  );
